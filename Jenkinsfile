pipeline{
    ...
    environment {
        ...
        //Dockerfile 文件地址
        ORDERSERVER_DOCKERFILE = "$WORKSPACE/devops/docker/order-server/Dockerfile"
        USERSERVER_DOCKERFILE = "$WORKSPACE/devops/docker/user-server/Dockerfile"
        ...
        //镜像名称
        ORDERSERVER_REGISTRY_IMAGE_NAME = "registry.cn-guangzhou.aliyuncs.com/ygrpc/order-server:$DEV_IMAGE_VERSION"
        USERSERVER_REGISTRY_IMAGE_NAME = "registry.cn-guangzhou.aliyuncs.com/ygrpc/user-server:$DEV_IMAGE_VERSION"
